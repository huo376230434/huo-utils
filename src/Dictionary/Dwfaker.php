...
namespace HuoUtils\Dictionary;

use HuoUtils\Dictionary\FakerTraits\CurrentAppFaker;
use HuoUtils\Dictionary\FakerTraits\FakerSentence;
...
class Dwfaker {
use FakerSentence,CurrentAppFaker;
